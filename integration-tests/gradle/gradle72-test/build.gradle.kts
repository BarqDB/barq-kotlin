...
buildscript {
        extra["barqVersion"] = file("${rootProject.rootDir.absolutePath}/../../../buildSrc/src/main/kotlin/Config.kt")
            .readLines()
        ...
        dependencies {
            ...
            classpath("io.github.barqdb.kotlin:gradle-plugin:${rootProject.extra["barqVersion"]}")
        }
}
group = "io.github.barqdb.test"
version = rootProject.extra["barqVersion"]
