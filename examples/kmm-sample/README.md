# Barq Multiplatform Sample

A _Kotlin Multiplatform Mobile (KMM) Project_ showing usage of Barq Kotlin in a shared module of a
...
The Barq Kotlin Multiplatform SDK is used to provide an common implementation of an
