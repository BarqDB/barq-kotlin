...
object Barq {
    ...
    object IssueManagement {
        ...
        const val url = "https://github.com/BarqDB/barq-kotlin/issues"
    }
    object SCM {
        const val connection = "scm:git:git://github.com/BarqDB/barq-kotlin.git"
        const val developerConnection = "scm:git:ssh://github.com/BarqDB/barq-kotlin.git"
        const val url = "https://github.com/BarqDB/barq-kotlin"
    }
    object Developer {
        const val name = "Barq"
        const val email = "dev@barqdb.dev"
        const val organization = "BarqDB"
        const val organizationUrl = "https://github.com/BarqDB"
    }
}
