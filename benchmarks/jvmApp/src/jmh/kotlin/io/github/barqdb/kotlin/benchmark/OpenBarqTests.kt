...
import io.github.barqdb.kotlin.benchmarks.SCHEMAS
...
/**
 * Benchmarking how fast it is to open a Barq.
...
open class OpenBarqTests {

    @Param("SINGLE", "SMALL", "LARGE") // Must match enum names
    var schemaSize: String = SchemaSize.SINGLE.name
    var barq: Barq? = null
    lateinit var config: BarqConfiguration

    @Setup(Level.Invocation)
    fun setUp() {
        val schema: Set<KClass<out BarqObject>> = SCHEMAS[schemaSize]!!.schemaObjects
