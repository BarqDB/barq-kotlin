# Barq Kotlin Benchmarks

This project contains microbenchmarks for the Barq Kotlin SDK. Benchmarks needs to be run on 
...
using this command:
```
adb pull /sdcard/Android/media/io.github.barqdb.kotlin.benchmarks.android.test ./benchmark-data/android/
```
