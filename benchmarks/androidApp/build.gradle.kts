...
android {
    namespace = "io.github.barqdb.kotlin.benchmarks.android"
    testNamespace = "io.github.barqdb.kotlin.benchmarks.android.test"
...
dependencies {
    androidTestImplementation("io.github.barqdb.kotlin:library-sync:${Barq.version}")
