...
// Full path to the root of the barq-kotlin repo
...
// Iterate through a local Maven repository and find all Barq Kotlin packages that neeeds to be uploaded.
val packages: List<String> = File(localMavenRepo, "io/github/barqdb/kotlin").listFiles()
...
packages.forEach { packageName ->
    ...
    val versionDirectory = File(localMavenRepo, "io/github/barqdb/kotlin/$packageName/$version")
