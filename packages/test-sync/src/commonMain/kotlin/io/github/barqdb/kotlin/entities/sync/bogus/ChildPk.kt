...
package io.github.barqdb.kotlin.entities.sync.bogus

import io.github.barqdb.kotlin.types.BarqObject
import io.github.barqdb.kotlin.types.annotations.PrimaryKey

/**
 * Represents the same entity as [io.github.barqdb.kotlin.entities.sync.ChildPk] but with a different `name` in
 * order to trigger an invalid schema error in Sync.
 */
class ChildPk : BarqObject {
