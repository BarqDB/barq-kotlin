...
internal val baseSupportedPrimitiveClasses = TypeDescriptor.elementTypesForList
    .filter { it.classifier != BarqObject::class } // Cannot have "pure" Collection<BarqObject>
...
internal val globalNonNullableTypes = globalNullablePrimitiveTypes.toMutableSet()
    .also { it.remove(BarqAny::class.simpleName) } // BarqAny must always be nullable for collections
    .toSet()
 ...
 * BarqObject/EmbeddedBarqObject dictionaries should be tested only in DictionaryTests since
 * BarqSet doesn't support EmbeddedObjects.
 */
