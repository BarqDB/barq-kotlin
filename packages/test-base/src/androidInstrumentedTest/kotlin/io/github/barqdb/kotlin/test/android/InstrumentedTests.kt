...
class InstrumentedTests {
    ...
    fun contextIsNotNull() {
        assertNotNull(BarqInitializer.filesDir)
    }
    ...
    fun query_parseErrorThrows() {
        val objects: BarqResults<Sample> = barq.query(Sample::class).find()
    ...
    fun query_delete() {
        ...
        assertEquals(0, barq.query(Sample::class).find().size)
    }
