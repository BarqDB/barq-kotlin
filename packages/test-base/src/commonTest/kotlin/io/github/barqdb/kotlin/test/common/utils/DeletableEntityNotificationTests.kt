 ...
 * the barq (i.e. BarqObject, BarqList, BarqSet, Backlinks but specifically not Barq and
 * BarqResults) should implement this interface to be sure that we test common behaviour across
 * those classes.
 */
interface DeletableEntityNotificationTests {
