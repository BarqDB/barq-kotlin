...
/**
 * All objects that are tied to a Barq (or implements BarqState) should test for all the
...
interface BarqStateTest {
    ...
    @Test
    fun version_throwsIfBarqIsClosed()
    ...
    @Test
    fun isFrozen_throwsIfBarqIsClosed()
