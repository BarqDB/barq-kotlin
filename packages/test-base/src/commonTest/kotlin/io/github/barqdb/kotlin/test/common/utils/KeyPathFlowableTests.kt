...
/**
 * All tests classes that tests classes exposing keypath notifications (BarqObject, BarqResults,
 * BarqList, BarqSet, BarqMap) should implement this interface to be sure that we test common
