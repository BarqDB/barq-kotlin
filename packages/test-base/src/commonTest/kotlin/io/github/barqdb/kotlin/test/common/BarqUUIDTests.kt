...
class BarqUUIDTests {
    ...
    fun from_uuidString() {
        ...
        assertFailsWithMessage<IllegalArgumentException>("Invalid string representation of an UUID: '893062aa-3207-49ad-xxxx-8db653771cdb'") {
            BarqUUID.from("893062aa-3207-49ad-xxxx-8db653771cdb") // invalid uuid value
        }
        ...
        assertFailsWithMessage<IllegalArgumentException>("Invalid string representation of an UUID: '893062aa320749ad931c8db653771cdb'") {
            BarqUUID.from("893062aa320749ad931c8db653771cdb") // invalid uuid value
        }
        ...
        assertFailsWithMessage<IllegalArgumentException>("Invalid string representation of an UUID: '00000000-0000-0000-0000-00000000000000000000-0000-0000-0000-000000000000'") {
            BarqUUID.from("00000000-0000-0000-0000-00000000000000000000-0000-0000-0000-000000000000") // invalid uuid value
        }

        // Boundaries
        assertContentEquals(
            ByteArray(16) { 0x00.toByte() },
            BarqUUID.from("00000000-0000-0000-0000-000000000000").bytes
        )

        assertContentEquals(
            ByteArray(16) { 0xFF.toByte() },
            BarqUUID.from("ffffffff-ffff-ffff-ffff-ffffffffffff").bytes
        )
    ...
    fun random() {
        ...
        repeat(10) {
            ...
            assertEquals(uuidVersion4, BarqUUID.random().bytes[6] and 0xF0.toByte())

            // validate variant, 8th byte must be 0b10xxxxxx or 0b110xxxxx
            assertContains(version4Variants, BarqUUID.random().bytes[8] and 0xC0.toByte())
    ...
    fun to_string() {
        ...
        for (uuidString in uuidTestStrings) {
            val uuid = BarqUUID.from(uuidString)
            val copy = BarqUUID.from(uuid.toString())

            assertEquals(uuid, copy)
            assertNotEquals(BarqUUID.random(), uuid)
        }
    }
    ...
    fun equals() {
        ...
        val uuid1 = BarqUUID.from(testString)
        val uuid2 = BarqUUID.from(testString)
