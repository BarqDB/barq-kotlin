...
import io.github.barqdb.kotlin.test.util.update
...
class BarqObjectNotificationsTests : BarqEntityNotificationTests {
    ...
    override fun keyPath_topLevelProperty() = runBlocking<Unit> {
        val c = TestChannel<ObjectChange<Sample>>()
        val obj: Sample = barq.write { copyToBarq(Sample()) }
        val observer = async {
