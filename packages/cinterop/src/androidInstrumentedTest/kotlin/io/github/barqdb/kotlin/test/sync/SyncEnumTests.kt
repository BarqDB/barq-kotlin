...
import io.github.barqdb.kotlin.internal.interop.CategoryFlags
import io.github.barqdb.kotlin.internal.interop.ErrorCategory
import io.github.barqdb.kotlin.internal.interop.ErrorCode
import io.github.barqdb.kotlin.internal.interop.barq_auth_provider_e
import io.github.barqdb.kotlin.internal.interop.barq_errno_e
import io.github.barqdb.kotlin.internal.interop.barq_error_category_e
import io.github.barqdb.kotlin.internal.interop.barq_flx_sync_subscription_set_state_e
import io.github.barqdb.kotlin.internal.interop.barq_sync_client_metadata_mode_e
import io.github.barqdb.kotlin.internal.interop.barq_sync_connection_state_e
...
import io.github.barqdb.kotlin.internal.interop.barq_sync_session_resync_mode_e
...
import io.github.barqdb.kotlin.internal.interop.barq_user_state_e
import io.github.barqdb.kotlin.internal.interop.barq_web_socket_errno_e
import io.github.barqdb.kotlin.internal.interop.sync.AuthProvider
...
import io.github.barqdb.kotlin.internal.interop.sync.MetadataMode
import io.github.barqdb.kotlin.internal.interop.sync.SyncConnectionErrorCode
import io.github.barqdb.kotlin.internal.interop.sync.SyncSessionErrorCode
...
class SyncEnumTests {
    ...
    @Test
    fun errorCategory() {
        checkEnum(barq_error_category_e::class) { nativeValue ->
    ...
    @Test
    fun authProvider() {
        checkEnum(barq_auth_provider_e::class) { nativeValue ->
    ...
    @Test
    fun clientErrorCode() {
        checkEnum(barq_errno_e::class) { nativeValue ->
    ...
    @Test
    fun coreUserState() {
        checkEnum(barq_user_state_e::class) { nativeValue ->
    ...
    @Test
    fun metadataMode() {
        checkEnum(barq_sync_client_metadata_mode_e::class) { nativeValue ->
    ...
    fun syncConnectionErrorCode() {
        checkEnum(barq_sync_errno_connection_e::class) { nativeValue ->
    ...
    fun syncSessionErrorCode() {
        checkEnum(barq_sync_errno_session_e::class) { nativeValue ->
    ...
    fun websocketErrorCode() {
        checkEnum(barq_web_socket_errno_e::class) { nativeValue ->
    ...
    fun syncSessionResyncMode() {
        checkEnum(barq_sync_session_resync_mode_e::class) { nativeValue ->
    ...
    fun syncSessionState() {
        checkEnum(barq_sync_session_state_e::class) { nativeValue ->
    ...
    fun syncSessionConnectionState() {
        checkEnum(barq_sync_connection_state_e::class) { nativeValue ->
    ...
    fun syncSubscriptionSetState() {
        checkEnum(barq_flx_sync_subscription_set_state_e::class) { nativeValue ->
    ...
    fun websocketResultCode() {
        checkEnum(barq_sync_socket_callback_result_e::class) { nativeValue ->
