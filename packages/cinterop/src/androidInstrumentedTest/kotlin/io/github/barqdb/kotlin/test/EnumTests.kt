...
class EnumTests {
     ...
     *
     * It checks that all the error code values defined in barq_errno_e are mapped by ErrorCode
     */
    @Test
    fun errorCodes() {
        val coreErrorCodesValues: IntArray = barq_errno_e::class.java.fields
            .map { it.getInt(null) }
            .toIntArray()
