...
/**
 * An **initializer** to allow Barq to access context properties.
 *
 * It is highly discouraged to do blocking operation as part of the app's startup sequence, but if
 * Barq is used from an [Initializer], that initializer needs to depend on the [BarqInitializer].
 */
class BarqInitializer : Initializer<Context> {
