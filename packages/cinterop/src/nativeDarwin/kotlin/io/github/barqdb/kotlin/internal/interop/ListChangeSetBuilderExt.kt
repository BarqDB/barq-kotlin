...
private fun CArrayPointer<barq_wrapper.barq_index_range_t>.asFromAccessor(): ArrayAccessor =
    { index -> this[index].from.toInt() }

private fun CArrayPointer<barq_wrapper.barq_index_range_t>.asToAccessor(): ArrayAccessor =
...
private fun <T, R> CollectionChangeSetBuilder<T, R>.initRangesArray(
    size: CArrayPointer<ULongVar>,
    ranges: CArrayPointer<barq_wrapper.barq_index_range_t>
