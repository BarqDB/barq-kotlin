...
data class ClassInfo(
    ...
    val flags: Int = ClassFlags.BARQ_CLASS_NORMAL
) {

    val isEmbedded = flags and ClassFlags.BARQ_CLASS_EMBEDDED != 0
    val isAsymmetric = flags and ClassFlags.BARQ_CLASS_ASYMMETRIC != 0
    ...
    companion object {
        ...
        fun create(
            ...
            val flags: Int = when {
                isEmbedded -> ClassFlags.BARQ_CLASS_EMBEDDED
                isAsymmetric -> ClassFlags.BARQ_CLASS_ASYMMETRIC
                else -> ClassFlags.BARQ_CLASS_NORMAL
            }
