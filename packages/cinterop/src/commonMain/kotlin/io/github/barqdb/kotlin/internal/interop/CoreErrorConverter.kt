...
/**
 * Generic representation of a Barq-Core exception.
 */
object CoreErrorConverter {
    ...
    fun asThrowable(
        ...
        return userError ?: when {
            ErrorCode.BARQ_ERR_INDEX_OUT_OF_BOUNDS == errorCode ->
                IndexOutOfBoundsException(message)
            ErrorCategory.BARQ_ERR_CAT_INVALID_ARG in categories && ErrorCategory.BARQ_ERR_CAT_SYNC_ERROR !in categories -> {
            ...
            ErrorCategory.BARQ_ERR_CAT_LOGIC in categories || ErrorCategory.BARQ_ERR_CAT_RUNTIME in categories ->
