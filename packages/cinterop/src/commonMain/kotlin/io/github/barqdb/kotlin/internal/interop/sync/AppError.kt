...
/**
 * Wrapper for C-API `barq_app_error`.
 * See https://github.com/BarqDB/barq-core/blob/master/src/barq.h#L2638
 */
data class AppError internal constructor(
     ...
     *
     * Any App category is also a [ErrorCategory.BARQ_ERR_CAT_RUNTIME] and [ErrorCategory.BARQ_ERR_CAT_APP_ERROR].
     */
