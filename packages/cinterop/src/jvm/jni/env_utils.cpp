...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *jvm, void *reserved) {
    cached_jvm = jvm;
    barq::_impl::JavaClassGlobalDef::initialize(barq::jni_util::get_env());
    return JNI_VERSION_1_2;
}

namespace barq {
    namespace jni_util {
        JNIEnv * get_env(bool attach_if_needed, bool is_daemon_thread, barq::util::Optional<std::string> thread_name) {
            JNIEnv *env;
