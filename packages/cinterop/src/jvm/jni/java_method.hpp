...
#ifndef BARQ_JNI_UTIL_JAVA_METHOD_HPP
#define BARQ_JNI_UTIL_JAVA_METHOD_HPP
...
public:
    ...
    // See https://github.com/barq/barq-java/issues/4964 for how to reproduce it.
...
#endif // BARQ_JNI_UTIL_JAVA_METHOD_HPP
