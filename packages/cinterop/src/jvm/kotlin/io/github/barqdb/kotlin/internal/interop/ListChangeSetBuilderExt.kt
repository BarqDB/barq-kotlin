...
private fun barq_index_range_t.asFromAccessor(): ArrayAccessor = { index: Int ->
    barqc.indexRangeArray_getitem(this, index).from.toInt()
}

private fun barq_index_range_t.asToAccessor(): ArrayAccessor = { index: Int ->
    barqc.indexRangeArray_getitem(this, index).to.toInt()
}
