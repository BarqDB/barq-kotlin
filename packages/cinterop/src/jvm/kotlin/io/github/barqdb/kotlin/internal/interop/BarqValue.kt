...
actual typealias BarqValueT = barq_value_t
actual class BarqValueList(actual val size: Int, val head: barq_value_t) {
    actual operator fun set(index: Int, value: BarqValue) {
        barqc.valueArray_setitem(head, index, value.value)
    }
}

internal fun Long.wrapPtrAsBarqValueT() = barq_value_t(this, false)
...
actual class BarqQueryArgumentList(val size: Long, val head: barq_query_arg_t)
