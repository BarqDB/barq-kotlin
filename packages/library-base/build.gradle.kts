...
kotlin {
    ...
    // Anything inside `io.github.barqdb.kotlin.internal.*` is considered internal regardless of their
...
// name and build type variant as a suffix, this default behaviour can cause mismatch at runtime https://github.com/BarqDB/barq-kotlin/issues/621
tasks.withType<KotlinCompile>().configureEach {
    compilerOptions.moduleName.set("io.github.barqdb.kotlin.library")
}
...
android {
    namespace = "io.github.barqdb.kotlin"
    ...
    // Skip BuildConfig generation as it overlaps with io.github.barqdb.kotlin.BuildConfig from barq-java
    buildFeatures {
        buildConfig = false
    }
...
barqPublish {
    pom {
        name = "Library"
        description = "Library code for Barq Kotlin. This artifact is not " +
...
tasks.withType<org.jetbrains.dokka.gradle.DokkaTaskPartial>().configureEach {
    moduleName.set("Barq Kotlin SDK")
    moduleVersion.set(Barq.version)
    dokkaSourceSets {
        configureEach {
            moduleVersion.set(Barq.version)
        ...
        val commonMain by getting {
            includes.from(
                ...
                "src/commonMain/kotlin/io/github/barqdb/kotlin/info.md",
                "src/commonMain/kotlin/io/github/barqdb/kotlin/log/info.md"
            )
