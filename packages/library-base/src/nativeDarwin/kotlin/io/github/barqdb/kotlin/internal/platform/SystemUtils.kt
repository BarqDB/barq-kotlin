...
public actual fun prepareBarqDirectoryPath(directoryPath: String): String {
...
public actual fun prepareBarqFilePath(directoryPath: String, filename: String): String {
    val dir = NSURL.fileURLWithPath(directoryPath, isDirectory = true)
    preparePath(directoryPath, dir)
    ...
    memScoped {
        ...
        if (!exists) {
            ...
            errorPtr.ptr.pointed.value?.let {
                throw IllegalArgumentException("Directories for Barq file could not be created: $directoryPath. Underlying cause: $it")
            }
        }
...
public actual fun copyAssetFile(
    ...
    NSFileManager.defaultManager.copyItemAtPath(assetFilePath, barqFilePath, null)
}
