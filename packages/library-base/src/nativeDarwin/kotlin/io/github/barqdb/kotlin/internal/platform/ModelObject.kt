 ...
 * classes (implementing [BaseBarqObject]) with its associated companion object (implementing
 * [BarqObjectCompanion]).
 *
...
@PublishedApi
internal annotation class ModelObject(public val companionClass: KClass<out BarqObjectCompanion>)
