...
internal class InitialObjectImpl<O : BaseBarqObject>(override val obj: O) : InitialObject<O>

internal class UpdatedObjectImpl<O : BaseBarqObject>(
    override val obj: O,
    override val changedFields: Array<String>
) : UpdatedObject<O>

internal class DeletedObjectImpl<O : BaseBarqObject> : DeletedObject<O> {
    override val obj: O?
        get() = null
}

internal class PendingObjectImpl<O : BaseBarqObject> : PendingObject<O> {
    override val obj: O?
        get() = null
}
