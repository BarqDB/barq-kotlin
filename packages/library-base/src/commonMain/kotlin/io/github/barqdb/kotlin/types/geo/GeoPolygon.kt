...
import io.github.barqdb.kotlin.internal.geo.UnmanagedGeoPolygon

/**
 * This class represents a polygon on the surface of the earth. It cannot be persisted - i.e you
 * can't declare a Barq property that is of type [GeoPolygon]. It can be only used as a query
...
public interface GeoPolygon {
     ...
     * val results = barq.query<Restaurant>("location GEOWITHIN $searchArea").find()
     * ```
     */
