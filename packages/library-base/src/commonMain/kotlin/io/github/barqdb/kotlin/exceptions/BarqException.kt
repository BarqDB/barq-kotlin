package io.github.barqdb.kotlin.exceptions

/**
 * Top level class for all exceptions that are Barq specific and doesn't have a better
 ...
 */
public open class BarqException : RuntimeException {
