...
/**
 * Copies an asset file into location if the barq files does not exist.
 *
 ...
 */
public expect fun copyAssetFile(barqFilePath: String, assetFilename: String, sha256Checksum: String?)
 ...
 * See https://github.com/BarqDB/barq-kotlin/issues/699
 */
public expect fun prepareBarqDirectoryPath(directoryPath: String): String

/**
 * Normalize and prepare a platform dependant path to a barq file.
 *
 ...
 * See https://github.com/BarqDB/barq-kotlin/issues/699
 */
public expect fun prepareBarqFilePath(directoryPath: String, filename: String): String

/**
 * Returns the default logger for the platform.
 */
public expect fun createDefaultSystemLogger(tag: String): BarqLogger
...
/**
 * Returns a BarqInstant representing the time that has passed since the Unix epoch.
 * For Android targets < API 26 there's no nano seconds precision.
 */
public expect fun currentTime(): BarqInstant
