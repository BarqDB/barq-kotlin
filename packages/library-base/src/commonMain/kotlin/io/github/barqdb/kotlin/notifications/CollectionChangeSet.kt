...
public interface ListChangeSet {
     ...
     * <p>
     * For [BarqResults], this means that one or more of the properties of the object at the given index were
...
/**
 * Convenience alias for [BarqDictionary] changesets. It represents a [MapChange] of `<String, V>`.
 */
