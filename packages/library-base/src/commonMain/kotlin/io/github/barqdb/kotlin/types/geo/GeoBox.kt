...
import io.github.barqdb.kotlin.internal.geo.UnmanagedGeoBox

/**
 * This class represents a rectangle on the surface of a the earth. It cannot be persisted - i.e you
 * can't declare a Barq property that is of type [GeoBox]. It can only be used as a query argument
...
public interface GeoBox {
     ...
     * val results = barq.query<Restaurant>("location GEOWITHIN $box").find()
     * ```
     */
