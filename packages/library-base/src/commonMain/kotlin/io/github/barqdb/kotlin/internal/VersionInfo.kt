...
/**
 * Version meta data for an overall [Barq]-instance with [VersionData] for the user-facing [Barq]
 * and the underlying [SuspendableNotifier]'s and [SuspendableWriter]'s live barqs.
 */
