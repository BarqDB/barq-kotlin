...
internal class InitialBarqImpl<R : BaseBarq>(override val barq: R) : InitialBarq<R>

internal class UpdatedBarqImpl<R : BaseBarq>(override val barq: R) : UpdatedBarq<R>
