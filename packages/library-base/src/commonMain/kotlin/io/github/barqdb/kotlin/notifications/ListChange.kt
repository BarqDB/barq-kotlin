...
/**
 * This sealed interface describes the possible changes that can happen to a [BarqList] collection.
 *
...
public sealed interface ListChange<T> {
    public val list: BarqList<T>
}

/**
 * Initial event to be observed on a [BarqList] flow. It contains a reference to the starting list
...
/**
 * [BarqList] flow event that describes that an update has been performed on the observed list. It
