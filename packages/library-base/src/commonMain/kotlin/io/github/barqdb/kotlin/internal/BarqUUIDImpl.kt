...
import io.github.barqdb.kotlin.internal.platform.SecureRandom
import io.github.barqdb.kotlin.internal.util.HEX_PATTERN
...
public class BarqUUIDImpl : BarqUUID {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return when (other) {
            null -> false
            is BarqUUID -> other.bytes.contentEquals(bytes)
            else -> false
        }
    }

    override fun hashCode(): Int {
        // We consider two BarqUUID's equal if they have the same byte sequence, so in
