...
import io.github.barqdb.kotlin.internal.newCategory

/**
 * Defines a log category for the Barq logger.
 */
public sealed interface LogCategory {
    ...
    public companion object {
        /**
         * Top level log category for Barq, updating this category level would set all other categories too.
         *
         * Category hierarchy:
         * ```
         * Barq
         ...
         * ```
         */
        public val Barq: BarqLogCategory = BarqLogCategory
 ...
 * ```
 */
public data object BarqLogCategory : LogCategory by newCategory("Barq") {
    /**
 ...
 * ```
 */
public data object StorageLogCategory : LogCategory by newCategory("Storage", BarqLogCategory) {
...
public data object SyncLogCategory :
    LogCategory by newCategory("Sync", BarqLogCategory) {
    /**
 ...
 * Log category for all app related logs.
 */
public data object AppLogCategory : LogCategory by newCategory("App", BarqLogCategory)

/**
 * Log category for all sdk related logs.
 */
public data object SdkLogCategory : LogCategory by newCategory("SDK", BarqLogCategory)
