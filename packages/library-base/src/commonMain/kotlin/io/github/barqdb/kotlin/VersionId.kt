...
/**
 * A `VersionId` representing the transactional id of the Barq itself or it's objects.
 *
 * Barq is an [MVCC](https://en.wikipedia.org/wiki/Multiversion_concurrency_control) database. This means that at any
 * given time, multiple version of data can be visible. This class describes the version of such data.
 *
 * The version of a Barq will change whenever a write is committed.
 */
public data class VersionId public constructor(public val version: Long) : Comparable<VersionId> {

    init {
        // Barq Core exposes these numbers as uint64_t, but it would be REALLY surprising if this ever
