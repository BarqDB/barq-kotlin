 ...
 */
package io.github.barqdb.kotlin.types.geo

import io.github.barqdb.kotlin.annotations.ExperimentalGeoSpatialApi
import io.github.barqdb.kotlin.internal.geo.UnmanagedGeoPoint
 ...
 *
 * This class cannot be persisted - i.e you can't declare a Barq property that is of type
 ...
 * - A List containing a Longitude/Latitude pair: `var coordinates: BarqList<Double> = barqListOf()`
 *
 * The recommended approach is encapsulating this inside its own [EmbeddedBarqObject], like this
 *
 * ```
 * public class Location: EmbeddedBarqObject {
 *    public constructor() // Empty constructor required by Barq. Should not be used.
 ...
 *    }
 *
 *    // Name and type required by Barq
 *    private var coordinates: BarqList<Double> = barqListOf()
 *
 *    // Name and type required by Barq
 ...
 *
 * ```
 * class Restaurant: BarqObject {
 *   var name: String = ""
 *   var location: Location? = null
 * }
 *
 * barq.write {
 *   copyToBarq(Restaurant().apply {
 *       name = "McBurger"
 ...
 * val restaurants = barq.query<Restaurant>("location GEOWITHIN $0", searchArea).find()
 * ```
 *
