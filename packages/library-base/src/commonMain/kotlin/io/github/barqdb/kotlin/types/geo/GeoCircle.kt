...
import io.github.barqdb.kotlin.internal.geo.UnmanagedGeoCircle

/**
 * This class represents a circle on the surface of the earth. It cannot be persisted - i.e you
 * can't declare a Barq property that is of type [GeoCircle]. It can be only used as a query
...
public interface GeoCircle {
     ...
     * val results = barq.query<Restaurant>("location GEOWITHIN $circle").find()
     * ```
     */
