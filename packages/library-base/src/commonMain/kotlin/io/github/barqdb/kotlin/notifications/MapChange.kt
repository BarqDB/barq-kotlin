...
/**
 * This sealed interface describes the possible changes that can happen to a [BarqMap].
 *
...
public sealed interface MapChange<K, V> {
    public val map: BarqMap<K, V>
}

/**
 * Initial event to be observed on a [BarqMap] flow. It contains a reference to the starting map
...
/**
 * [BarqMap] flow event that describes that an update has been performed on the observed map. It
