...
/**
 * Minimal live Barq implementation that only allows queries and write transactions without being
 * able to observe for changes.
 */
public class MutableLiveBarqImpl(
    dbPointer: LiveBarqPointer,
    configuration: InternalConfiguration,
) : InternalTypedBarq, InternalMutableBarq, WriteTransactionManager, BaseBarqImpl(configuration) {
    ...
    override fun <T : TypedBarqObject> query(
        ...
        query: String,
        vararg args: Any?
    ): BarqQuery<T> = super.query(clazz, query, *args)
}
