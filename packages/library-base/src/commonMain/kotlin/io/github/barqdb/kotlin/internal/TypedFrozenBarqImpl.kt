...
/**
 * Minimal frozen Barq implementation that only allows launching queries against it.
 */
public class TypedFrozenBarqImpl(
    dbPointer: FrozenBarqPointer,
    configuration: InternalConfiguration,
) : InternalTypedBarq, BaseBarqImpl(configuration) {
