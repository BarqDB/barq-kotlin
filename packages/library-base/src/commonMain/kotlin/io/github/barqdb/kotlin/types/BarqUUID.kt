 ...
 *
 * UUIDs created with BarqUUID conforms to RFC 4122 version 4 and are created with random bytes.
 */
@Suppress("EqualsWithHashCodeExist") // Only overwriting equals to make docs available to user
public interface BarqUUID {
    public companion object {
        /**
         * Generates a new [BarqUUID] type 4 (pseudo randomly generated) UUID.
         *
         * @return A randomly generated UUID
         */
        public fun random(): BarqUUID = BarqUUIDImpl()

        /**
         * Generates a new [BarqUUID] from the UUID formatted string. UUID are represented as
         ...
         */
        public fun from(uuidString: String): BarqUUID = BarqUUIDImpl(uuidString)

        /**
         * Generates a new [BarqUUID] based on the specified byte array. A valid UUID is represented
         ...
         */
        public fun from(bytes: ByteArray): BarqUUID = BarqUUIDImpl(bytes)
    }
