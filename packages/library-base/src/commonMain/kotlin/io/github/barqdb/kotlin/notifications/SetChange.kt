...
/**
 * This sealed interface describes the possible changes that can happen to a [BarqSet] collection.
 *
...
public sealed interface SetChange<T> {
    public val set: BarqSet<T>
}

/**
 * Initial event to be observed on a [BarqSet] flow. It contains a reference to the starting set
...
/**
 * [BarqSet] flow event that describes that an update has been performed on the observed set. It
