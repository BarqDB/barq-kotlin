...
/**
 * Triggers generation of synthetic methods on Barq model classes, in particular
 * `toString()`, `equals()` and `hashCode()`.
 */
@Suppress("ComplexCondition")
class BarqModelSyntheticMethodsExtension : SyntheticResolveExtension {
    ...
    override fun generateSyntheticMethods(
        ...
        if (thisDescriptor.isBarqObject &&
            ...
            !isNestedInBarqModelClass(thisDescriptor) && /* do not override nested class methods */
    ...
    private fun isNestedInBarqModelClass(classDescriptor: ClassDescriptor): Boolean {
