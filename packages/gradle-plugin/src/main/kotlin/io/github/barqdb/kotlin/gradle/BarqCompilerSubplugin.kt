...
import io.github.barqdb.kotlin.gradle.analytics.AnalyticsErrorCatcher
import io.github.barqdb.kotlin.gradle.analytics.AnalyticsService
import io.github.barqdb.kotlin.gradle.analytics.AnalyticsService.Companion.UNKNOWN
import io.github.barqdb.kotlin.gradle.analytics.AnalyticsService.Companion.unknown
import io.github.barqdb.kotlin.gradle.analytics.BuilderId
import io.github.barqdb.kotlin.gradle.analytics.ComputerId
import io.github.barqdb.kotlin.gradle.analytics.HOST_ARCH_NAME
import io.github.barqdb.kotlin.gradle.analytics.HOST_OS_NAME
import io.github.barqdb.kotlin.gradle.analytics.ProjectConfiguration
import io.github.barqdb.kotlin.gradle.analytics.TargetInfo
import io.github.barqdb.kotlin.gradle.analytics.hexStringify
import io.github.barqdb.kotlin.gradle.analytics.sha256Hash
...
class BarqCompilerSubplugin : KotlinCompilerPluginSupportPlugin, AnalyticsErrorCatcher {
    ...
    companion object {
        ...
        const val groupId = "io.github.barqdb.kotlin"
        ...
        const val compilerPluginId = "io.github.barqdb.kotlin"

        // Must match io.github.barqdb.kotlin.compiler.bundleIdKey
        const val bundleIdKey = "bundleId"

        // Must match io.github.barqdb.kotlin.compiler.
    ...
    override fun apply(target: Project) {
        ...
        printAnalytics = target.providers.environmentVariable("BARQ_PRINT_ANALYTICS").getBoolean()
        submitAnalytics = !target.gradle.startParameter.isOffline && !target.providers.environmentVariable("BARQ_DISABLE_ANALYTICS").getBoolean()
        ...
        failOnAnalyticsError = target.providers.environmentVariable("BARQ_FAIL_ON_ANALYTICS_ERRORS").getBoolean()
    ...
    private fun provider(target: Project) =
        target.gradle.sharedServices.registerIfAbsent(
            ...
            // want to track builds directly using Barq.
            var usesSync: Boolean = withDefaultOnError("Uses Sync", false) {
                ...
                for (conf in target.configurations) {
                    for (dependency in conf.dependencies) {
                        if (dependency.group == "io.github.barqdb.kotlin" && dependency.name == "library-sync") {
    ...
    override fun isApplicable(kotlinCompilation: KotlinCompilation<*>): Boolean {
        return kotlinCompilation.target.project.plugins.findPlugin(BarqCompilerSubplugin::class.java) != null
    }
...
fun nativeArch(target: KonanTarget): String = try {
    when (target.architecture) {
        Architecture.X64 -> io.github.barqdb.kotlin.gradle.analytics.Architecture.X64.serializedName
        Architecture.X86 -> io.github.barqdb.kotlin.gradle.analytics.Architecture.X86.serializedName
        Architecture.ARM64 -> io.github.barqdb.kotlin.gradle.analytics.Architecture.ARM64.serializedName
        Architecture.ARM32 -> io.github.barqdb.kotlin.gradle.analytics.Architecture.ARM.serializedName
...
fun androidArch(target: String): String = when (target) {
    "armeabi-v7a" -> io.github.barqdb.kotlin.gradle.analytics.Architecture.ARM.serializedName
    "arm64-v8a" -> io.github.barqdb.kotlin.gradle.analytics.Architecture.ARM64.serializedName
    "x86" -> io.github.barqdb.kotlin.gradle.analytics.Architecture.X86.serializedName
    "x86_64" -> io.github.barqdb.kotlin.gradle.analytics.Architecture.X64.serializedName
    else -> unknown(target)
}
