...
/**
 * An **initializer** for Sync specific functionality that does not fit into the `BarqInitializer`
 * in cinterop.o allow Barq to access context properties.
 */
internal class BarqSyncInitializer : Initializer<Context> {

    companion object {
        val logger: ContextLogger = ContextLogger("BarqSyncInitializer")
    ...
    override fun dependencies(): MutableList<Class<out Initializer<*>>> {
        return mutableListOf(BarqInitializer::class.java)
    }
}
