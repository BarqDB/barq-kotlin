...
public suspend fun <T : BarqObject> BarqResults<T>.subscribe(
    name: String,
    updateExisting: Boolean = false,
    mode: WaitForSync = WaitForSync.FIRST_TIME,
    timeout: Duration = Duration.INFINITE
): BarqResults<T> {
    val query: BarqQuery<T> = this.query(TRUE_PREDICATE)
