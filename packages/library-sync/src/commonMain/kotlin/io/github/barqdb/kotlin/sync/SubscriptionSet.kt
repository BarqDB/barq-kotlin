 ...
 * Barq that has been configured for Flexible Sync.
 *
 * Flexible Sync is a way of defining which data gets synchronized to and from the device using
 * [BarqQuery]s. The query and its metadata are represented by a [Subscription].
 *
 ...
 */
public interface SubscriptionSet<T : BaseBarq> : BaseSubscriptionSet {
     ...
     */
    public suspend fun update(block: MutableSubscriptionSet.(barq: T) -> Unit): SubscriptionSet<T>
