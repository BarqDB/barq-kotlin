...
public interface MutableSubscriptionSet : BaseSubscriptionSet {
     ...
     */
    public fun <T : BarqObject> add(query: BarqQuery<T>, name: String? = null, updateExisting: Boolean = false): Subscription
     ...
     */
    public fun BarqQuery<out BarqObject>.subscribe(): Subscription = add(this)
     ...
     */
    public fun BarqQuery<out BarqObject>.subscribe(name: String, updateExisting: Boolean = false): Subscription =
     ...
     * @throws IllegalArgumentException if [objectType] is not part of the Schema for this Barq.
     */
     ...
     * @throws IllegalArgumentException if [objectType] is not part of the Schema for this Barq.
     */
    public fun <T : BarqObject> removeAll(type: KClass<T>): Boolean
